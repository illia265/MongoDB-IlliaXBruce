    ...
    <div className="min-h-screen bg-gray-50">
              ...
              <>
                {jobs.length > 0 && (
                  <button
                    ...
                    className="px-3 py-2 rounded-xl border border-gray-300 text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center gap-2"
                  >
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="max-w-lg mx-auto mb-10">
            ...
            >
              <input
                ...
                accept=".pdf,.docx,.txt"
              />
              <Upload className={`w-8 h-8 mb-2 ${profileId ? 'text-green-500' : 'text-gray-400'}`} />
              <p className={`text-sm font-medium ${profileId ? 'text-green-700' : 'text-gray-600'}`}>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="flex items-center bg-white rounded-2xl border border-gray-300 shadow-sm overflow-hidden">
            ...
            <button
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-4 font-medium transition-colors rounded-r-2xl"
            >
