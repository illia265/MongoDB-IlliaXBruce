                                            ...
                                            {analysis.publications && analysis.publications.length > 0 && (
                                                <div className="space-y-2">
                                                    {analysis.publications.map((pub, pidx) => (
                                                        <div key={pidx} className="flex items-start gap-2 p-2 bg-gray-50 rounded-md">
                                                            {pub.verified && (
                                                                <span className="mt-0.5 w-4 h-4 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
                                                                    <span className="text-white text-[10px]">✓</span>
                                                                </span>
                                                            )}
                                                            <div className="flex-1 min-w-0">
                                                                <p className="text-sm text-gray-800 leading-snug">{pub.title} <span className="text-gray-400">({pub.year})</span></p>
